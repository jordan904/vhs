...
const services = [
  ...
  { value: "lvp-flooring", label: "LVP Flooring" },
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-3 hover-slide-right">
                        <MapPin className="h-5 w-5 text-[oklch(0.65_0.18_88)] shrink-0 mt-0.5" />
                        <div>
                      ...
                      <div className="flex items-center gap-3 hover-slide-right">
                        <Phone className="h-5 w-5 text-[oklch(0.65_0.18_88)] shrink-0" />
                        <a
                          href="tel:+19028245333"
                          className="text-foreground hover:text-[oklch(0.65_0.18_88)] transition-colors"
                        >
                          (902) 824-5333
                        </a>
                      </div>
